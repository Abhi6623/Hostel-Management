...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 290, 250, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1180, 20, -1, -1));
 ...
 int a=JOptionPane.showConfirmDialog(null,"Do you want to exit the Application","Alert..!"
                 + "",JOptionPane.YES_NO_OPTION);
         //JOptionPane.showMessageDialog(null,"Hi In The Message","PopUp Dialogue", JOptionPane.INFORMATION_MESSAGE);
        if(a==0)
        {
            System.exit(0);
